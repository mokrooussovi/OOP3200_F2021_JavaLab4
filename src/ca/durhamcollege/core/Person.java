...
{
    // ATTRIBUTES
    protected ArrayList<String> myNames; // Stores the person's names
    protected LocalDate myBirthDate; // the person's birth date
    ...
    {
        String outputString = "";
        outputString += "The Person name           is: " + this.myNames + "\n";
        outputString += "The Person date of birth  is: " + this.myBirthDate +"\n";
        return outputString;
    }
}
